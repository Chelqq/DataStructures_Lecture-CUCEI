...
int main () {
	...
	do{
		...
		cout << "\t3- Ordenar canciones." << endl;
		cout << "\t4- Eliminar cancion." << endl;
		cout << "\t5- Agregar una lista de canciones." << endl;
		cout << "\t6- Guardar lista actual." << endl;
		cout << "\t0- Salir" << endl;
...
void sortSong(List<Song>& myLista){
